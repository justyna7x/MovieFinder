...
const createMovieRating = (vote_average)=>{
    ...
    const movieRating1 = document.createElement('p');
    movieRating1.setAttribute('id', 'movieRating');
    movieRating1.innerHTML = `<strong>The movie rating is:</strong> ${vote_average}`;

    return movieRating1;
}

//Create Cast for the movie
const createMovieCast = (cast)=>{
    const MovieCast = document.createElement('p');
    MovieCast.setAttribute('id', 'movieCast');
    MovieCast.innerHTML = `<strong>Starring</strong>: ${cast}`;
    return MovieCast;
...
const createReleaseDate = (date) =>{
    ...
    releaseDate.innerHTML = `<strong>Release date:</strong> ${date}`;
    return releaseDate;
